    ...
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-950 relative transition-colors duration-300">
      <div className="pt-8 px-8 pb-0 shrink-0">
        <div className="max-w-7xl mx-auto flex justify-between items-end">
          <div>
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-slate-100">{t.debts}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs font-black text-slate-400 uppercase tracking-widest">{t.amount}</span>
              </div>
              <p className="text-2xl font-black text-slate-900 dark:text-slate-100">{formatCurrency(totalAmount)}</p>
            </div>
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs font-black text-slate-400 uppercase tracking-widest">{t.paid}</span>
              </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs font-black text-slate-400 uppercase tracking-widest">{t.remaining}</span>
              </div>
              <p className="text-2xl font-black text-amber-600 dark:text-amber-400">{formatCurrency(totalRemaining)}</p>
            </div>
          </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-slate-50 dark:border-slate-800">
                      <th className="py-6 px-8 text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">
                        {activeTab === 'payable' ? t.supplierName : t.customerName}
                      </th>
                      <th className="py-6 px-6 text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest text-right">{t.amount}</th>
                      <th className="py-6 px-6 text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest text-right">{t.paidAmount}</th>
                      <th className="py-6 px-6 text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest text-right">{t.remaining}</th>
                      <th className="py-6 px-6 text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">{t.dueDate}</th>
                      ...
                      return (
                        <tr key={debt.id} className="group hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                {activeTab === 'receivable' && debt.customer?.phone && (
                                  <span className="text-xs text-slate-400 dark:text-slate-500">{debt.customer.phone}</span>
                                )}
                              </div>
                            </div>
                          </td>
                          <td className="py-5 px-6 text-right">
                            <span className="font-bold text-slate-900 dark:text-slate-100">{formatCurrency(debt.amount)}</span>
                          </td>
                          <td className="py-5 px-6 text-right">
                            <span className="font-bold text-emerald-600 dark:text-emerald-400">{formatCurrency(debt.amountPaid)}</span>
                          </td>
                          <td className="py-5 px-6 text-right">
                            <span className="font-bold text-amber-600 dark:text-amber-400">{formatCurrency(debt.remaining)}</span>
                          </td>
                          ...
                          <td className="py-5 px-6 text-center">
                            <span className={cn(
                              "px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 mx-auto w-fit",
                              statusInfo.class
                            )}>
                              <StatusIcon size={12} />
                            ...
                            <div className="flex items-center justify-end gap-2">
                              {debt.remaining > 0 && (
                                <button
                                  ...
                                  className="h-10 px-4 flex items-center gap-2 bg-gradient-brand text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-gradient-brand-dark transition-all"
                                >
